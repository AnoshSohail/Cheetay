...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recentlyViewedList.add(new RecentlyViewed("Pasta","Have some tasty pasta for meal","Rs.450 ","1","Plate",R.drawable.card4,R.drawable.b4));
        recentlyViewedList.add(new RecentlyViewed("Samosa","Order Samosa Now","Rs.15","2","Pcs",R.drawable.card3,R.drawable.b3));
        recentlyViewedList.add(new RecentlyViewed("Burger","Order your favorite burger","Rs.170","1","Pcs",R.drawable.card2,R.drawable.b1));
        recentlyViewedList.add(new RecentlyViewed("Biryani","Enjoy Biryani","Rs.150","1","Plate",R.drawable.card1,R.drawable.b2));
        setRecentlyRecycler();
    }
